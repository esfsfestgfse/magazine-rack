...
if (SHELVES.length !== 47 || !SHELVES.some((shelf) => shelf.id === 'manga') || !SHELVES.some((shelf) => shelf.id === 'batman')) throw new Error(`Shelf parity check failed: expected 47 shelves with Manga and Batman racks, found ${SHELVES.length}`);
...
console.log('Shelf parity check passed (47 readable shelves including Manga and Batman; restricted shelves last).');
