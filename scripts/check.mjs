...
if (SHELVES.length !== 51 || !['manga', 'batman', 'spiderman', 'superman', 'xmen', 'archie'].every((id) => SHELVES.some((shelf) => shelf.id === id))) throw new Error(`Shelf parity check failed: expected 51 shelves with Manga and character racks, found ${SHELVES.length}`);
...
console.log('Shelf parity check passed (51 readable shelves including Manga and four character racks; restricted shelves last).');
